 ...
 * 
 */
@WebServiceClient(name = "BanqueWs", targetNamespace = "http://ws.enset.org/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.enset.org/", "BanqueWs");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.enset.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.enset.org/", "BanqueServicePort"), BanqueService.class, features);
    }
