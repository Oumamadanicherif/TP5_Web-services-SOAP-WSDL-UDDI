...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.enset.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.enset.org/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://ws.enset.org/", "compte");
    private static final QName _CompteList_QNAME = new QName("http://ws.enset.org/", "compteList");
    private static final QName _CompteListResponse_QNAME = new QName("http://ws.enset.org/", "compteListResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.enset.org/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.enset.org/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "compteList")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "compteListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.enset.org/", name = "getCompteResponse")
